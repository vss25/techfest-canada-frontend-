// schemas/sponsor.ts
// Place this file in your Sanity project's schemas folder and
// import + add it to your schemaTypes array in schemas/index.ts
...
export default defineType({
  ...
  preview: {
    ...
    prepare({ title, media, subtitle }: { title: string; media: PreviewValue["media"]; subtitle: boolean }): PreviewValue {
      return {
        title,
        media,
